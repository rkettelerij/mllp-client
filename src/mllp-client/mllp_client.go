...
func main() {
	...
	port := flag.Int("port", 2575, "port number of MLLP server, default value is 2575")
	file := flag.String("file", emptyFilename, "path to file whose contents will be sent to the MLLP server")
